  ...
  return (
    <div className="w-full relative bg-gradient-to-b from-[#111111]/70 to-[#090909]/90 border border-gold/20 rounded-2xl p-6 md:p-8 overflow-hidden shadow-[0_20px_50px_rgba(0,0,0,0.5)] group">
      ...
      <div className="relative w-full">
        ...
        <div className="w-full overflow-x-auto pb-4 map-scrollbar">
          <div className="min-w-[760px] md:min-w-0 w-full aspect-[2.1/1] relative select-none">
        ...
        <AnimatePresence>
          {activeDetail && (
            <motion.div
              ...
              className="absolute bottom-6 left-4 right-4 md:right-auto md:left-6 md:w-80 glassmorphic p-5 rounded-xl shadow-2xl border border-gold/30 z-20"
            >
